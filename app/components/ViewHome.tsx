    ...
    <>
      <div className="w-10/12 mx-auto relative flex flex-col gap-24">
        ...
        <div id="home" className="flex min-h-screen items-center justify-center flex-col md:flex-row md:justify-between gap-3">
          <div data-aos="fade-up" className="flex flex-col gap-5 order-2 items-center md:order-1 md:items-start">
          ...
          <Image src={'/images/count.png'} data-aos="fade-down" alt="count" width={423} height={353} className="w-[323px] h-[253px] order-1 md:w-[423px] md:h-[353px] md:order-2" />
        </div>
        <div id="benefits" className="flex flex-col items-center gap-10 text-center">
          <h2 data-aos="fade-up" className="text-xl font-bold">Benefits when use this app</h2>
          <div className="flex gap-12 snap-x snap-mandatory overflow-x-scroll w-full md:overflow-hidden md:w-auto">
            <div data-aos="fade-down" className="flex flex-col items-center min-w-full md:min-w-52 md:w-52 snap-center">
        ...
        <div className="flex gap-8 flex-col md:flex-row">
          <Image data-aos="fade-up" src={'/images/holiday.png'} alt="holiday" width={423} height={414} className="w-[323px] h-[314px] md:w-[423px] md:h-[414px]" />
        ...
        <div id="options" className="flex gap-8 flex-col md:flex-row">
          ...
          <Image data-aos="fade-down" src={'/images/note.png'} alt="note" width={410} height={410} className="order-1 w-[310px] h-[310px] md:order-2 md:w-[410px] md:h-[410px]" />
        </div>
      </div>
      <ViewFooter />
    </>
